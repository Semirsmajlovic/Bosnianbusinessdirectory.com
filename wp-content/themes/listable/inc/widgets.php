	...
	public function widget( $args, $instance ) {
		...
		<div class="listing-map-content">
			...
			<?php if ( ! empty( $get_directions_link ) ) { ?>
				<a href="<?php echo $get_directions_link; ?>" class="listing-address-directions" target="_blank"><?php esc_html_e( 'View in Google Maps.', 'listable' ); ?></a>
			<?php } ?>
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $photos ) ) :
			...
			<header class="listing-gallery__header">
				<h2 class="listing-gallery__title"><?php esc_html_e( 'Photo Gallery:', 'listable' ); ?></h2>
