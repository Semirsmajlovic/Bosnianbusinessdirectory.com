...
class Pixcloud_Admin_Notifications {
	...
	public function add_hooks() {
		...
		add_filter( 'pixelgrade_cloud_request_data', array( $this, 'add_data_to_request' ), 10, 1 );
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_enqueue_script( 'pixcloud-admin-notifications-js', $this->url_to_assets_dir . 'admin-notifications.js', array( 'jquery' ), $this->version );
		wp_enqueue_style( 'pixcloud-admin-notifications-css', $this->url_to_assets_dir . 'admin-notifications.css', array(), $this->version );
	}
	 ...
	 */
	public function remove_user_notifications_data( $user_id = 0, array $notice_ids = array() ) {
